 ...
 *
 * One snapshot per scanned page, named in fixtures/testData.ts. They overlap
 * heavily, because this site renders its whole mega-menu into every page, and
 * that is the point: a nav link that disappears from one template but not the
 * others is exactly the regression a single combined snapshot would hide.
 *
